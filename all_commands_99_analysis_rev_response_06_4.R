...
#     -6.4.1 GO enrichment of 1659 windows
#     -6.4.2 PCA with 1659 windows
#     -6.4.3 PCA with 1659 windows with outgroups
#     -6.4.4 PCA with 1659 windows without gill raker associated chromosome scaff22
...
# print results
write.table(res.CC_raw,file=paste0("reviewer_responses/GOenrichment_1659_CC_nodeSize",nodeS,".csv",sep=""),sep=",",col.names = T,row.names = F)
write.table(res.BP_raw,file=paste0("reviewer_responses/GOenrichment_1659_BP_nodeSize",nodeS,".csv",sep=""),sep=",",col.names = T,row.names = F)
write.table(res.MF_raw,file=paste0("reviewer_responses/GOenrichment_1659_MF_nodeSize",nodeS,".csv",sep=""),sep=",",col.names = T,row.names = F)
...
write.table(full_GO_output,file="reviewer_responses/full_GO_output_1659_nodes10.csv",sep=",",col.names = T,row.names = F)
...
pca <- read_table("reviewer_responses/All_1659_allsnps_filt.eigenvec", col_names = FALSE)
eigenval <- scan("reviewer_responses/All_1659_allsnps_filt.eigenval")
...
#
#tiff("reviewer_responses/All_1659PC1PC2.tiff", height=8, width=8, units="in", res=300, compression="lzw")
plot(pca$PC1, 
     pca$PC2, 
...
#get input for gwas - indiv \t indiv \t PC1
#need to make positive but similarly spaced so add 1 + most negative value
Gwas_input_DF <- pca[,1:2]
Gwas_input_DF$individual <- paste("0", Gwas_input_DF$ind, sep = "")
min_CS <- min(Gwas_input_DF$PC1)
Gwas_input_DF$CS_PC1 <- (Gwas_input_DF$PC1 + min_CS + 1)

plot(Gwas_input_DF$PC1, Gwas_input_DF$CS_PC1)

newgwas_input <- as.data.frame(cbind(Gwas_input_DF$individual, Gwas_input_DF$individual, Gwas_input_DF$CS_PC1))

write.table(newgwas_input, file = "./CS_EMMAX_input.pheno", col.names = FALSE, row.names = FALSE, quote = FALSE, sep = "\t")
...
summary(PC1_GRC)
#Multiple R-squared:  0.3921,	Adjusted R-squared:  0.3852 
#F-statistic: 56.76 on 1 and 88 DF,  p-value: 4.1e-11
...
#Multiple R-squared:  0.5107,	Adjusted R-squared:  0.505 
#F-statistic: 88.73 on 1 and 85 DF,  p-value: 7.634e-15
...
#F-statistic: 68.78 on 1 and 16 DF,  p-value: 3.465e-07
...
summary(PC1_GRC_W)
#Multiple R-squared:  0.7167,	Adjusted R-squared:  0.699 
#F-statistic: 40.47 on 1 and 16 DF,  p-value: 9.433e-06
...
#F-statistic: 42.91 on 1 and 28 DF,  p-value: 4.215e-07
...
summary(PC1_GRC_N)
#Multiple R-squared:  0.6857,	Adjusted R-squared:  0.6507 
#F-statistic: 19.63 on 1 and 9 DF,  p-value: 0.001645
...
summary(PC1_GRC_C)
#Multiple R-squared:  0.3703,	Adjusted R-squared:  0.2915 
#F-statistic: 4.703 on 1 and 8 DF,  p-value: 0.06194
...
#F-statistic:  87.3 on 1 and 88 DF,  p-value: 8.06e-15
...
summary(PC1_SL_L)
#Multiple R-squared:  0.322,	Adjusted R-squared:  0.2796 
#F-statistic: 7.598 on 1 and 16 DF,  p-value: 0.01405
...
summary(PC1_SL_W)
#Multiple R-squared:  0.6925,	Adjusted R-squared:  0.6733 
#F-statistic: 36.03 on 1 and 16 DF,  p-value: 1.843e-05
...
summary(PC1_SL_B)
#Multiple R-squared:  0.3547,	Adjusted R-squared:  0.3332 
#F-statistic: 16.49 on 1 and 30 DF,  p-value: 0.0003233
...
summary(PC1_SL_N)
#Multiple R-squared:  0.6738,	Adjusted R-squared:  0.6412 
#F-statistic: 20.65 on 1 and 10 DF,  p-value: 0.001067
...
summary(PC1_SL_C)
#Multiple R-squared:  0.1215,	Adjusted R-squared:  0.01166 
#F-statistic: 1.106 on 1 and 8 DF,  p-value: 0.3236
...
#plot for fig5
par(mfrow=c(2,2))
#tiff("../FIGURE5_1659.tiff", height=12, width=12, units="in", res=300, compression="lzw")
...
plot(gill$PC1, gill$gill_plot, col = as.character(gill$colour_plot), 
     ...
     lwd = 2,
     ylab = "Gill raker count",
     ylim = c(min(gill$gill_plot), max(gill$gill_plot)),
     xlab = (paste0("PC1 (", signif(pve$pve[1], 3), "%)")))
#main = ("PC1 vs. gill raker count")
abline(lm(gill$gill_plot ~ gill$PC1), lty = 2, col = "black", lwd = 2)
abline(lm(gill_noprof$gill_plot ~ gill_noprof$PC1), lty = 2, col = "grey", lwd = 2)
...
pca <- read_table("reviewer_responses/All_1659_allsnps_wout_filt.eigenvec", col_names = FALSE)
eigenval <- scan("reviewer_responses/All_1659_allsnps_wout_filt.eigenval")
...
pca <- read_table("reviewer_responses/All_1659_allsnps_noGRCpeak_filt.eigenvec", col_names = FALSE)
eigenval <- scan("reviewer_responses/All_1659_allsnps_noGRCpeak_filt.eigenval")
...
################3
pca <- read_table("reviewer_responses/1659_excl_parallel_filt.eigenval", col_names = FALSE)
eigenval <- scan("reviewer_responses/1659_excl_parallel_filt.eigenval")
...
#plot lakewise PC1 vs lake
tiff("reviewer_responses/342_noparallel_PC1_vs_lake.tiff", height=8, width=12, units="in", res=300, compression="lzw")
par(mar=c(5,9,4,1)+.2)
plot(newplot2_df$PC1, newplot2_df$plotnumber,
     col = as.character(newplot2_df$colour_plot),
     pch = newplot2_df$symb,
...
##NEW
#Multiple R-squared:  0.1691,	Adjusted R-squared:  0.1562 
#F-statistic: 13.03 on 1 and 64 DF,  p-value: 0.0006027
...
##NEW
#Multiple R-squared:  0.2514,	Adjusted R-squared:  0.2391 
#F-statistic: 20.48 on 1 and 61 DF,  p-value: 0.00002843

GRC_r2_NOPROF <- summary(PC1_GRC_NOPROF)$r.squared
GRC_r2_2dp_NOPROF <- format(round(GRC_r2_NOPROF, 3), nsmall = 3)

plot(gill_noprof$PC1, gill_noprof$gill_plot, col = as.character(gill_noprof$colour_plot), 
     pch=gill_noprof$symb, 
     lwd = 2,
     ylab = "gill raker count",
     xlab = (paste0("PC1 (", signif(pve$pve[1], 3), "%)")),
     main = paste("PC1 vs. gill raker count - R2 =", GRC_r2_2dp_NOPROF))
...
##NEW
#Multiple R-squared:  0.675,	Adjusted R-squared:  0.6425 
#F-statistic: 20.77 on 1 and 10 DF,  p-value: 0.001047
...
##NEW
#Multiple R-squared:  0.6853,	Adjusted R-squared:  0.6538 
#F-statistic: 21.77 on 1 and 10 DF,  p-value: 0.0008862
...
##NEW
#Multiple R-squared:  0.5819,	Adjusted R-squared:  0.5629 
#F-statistic: 30.62 on 1 and 22 DF,  p-value: 0.00001462
...
##NEW
#Multiple R-squared:  0.1327,	Adjusted R-squared:  -0.1564 
#F-statistic: 0.459 on 1 and 3 DF,  p-value: 0.5467
...
##NEW
#Multiple R-squared:  0.2592,	Adjusted R-squared:  0.1666 
#F-statistic: 2.799 on 1 and 8 DF,  p-value: 0.1329
...
##excl. biel/neuchatl and constance which are non-significant associations
tiff("reviewer_responses/All_342_noparallel_PC1_vs_GillRaker_noprof_FIG1.tiff", height=8, width=10, units="in", res=300, compression="lzw")
plot(gill$PC1, gill$gill_plot, col = as.character(gill$colour_plot), 
     pch=gill$symb, 
     lwd = 2,
     ylab = "gill raker count",
...
##NEW
#Multiple R-squared:  0.2102,	Adjusted R-squared:  0.1979 
#F-statistic: 17.04 on 1 and 64 DF,  p-value: 0.0001082
...
##NEW
#Multiple R-squared:  0.272,	Adjusted R-squared:  0.1991 
#F-statistic: 3.735 on 1 and 10 DF,  p-value: 0.08207
...
##NEW
#Multiple R-squared:  0.524,	Adjusted R-squared:  0.4764 
#F-statistic: 11.01 on 1 and 10 DF,  p-value: 0.007775
...
##NEW
#Multiple R-squared:  0.2895,	Adjusted R-squared:  0.2599 
#F-statistic:  9.78 on 1 and 24 DF,  p-value: 0.004578
...
##NEW
#Multiple R-squared:  0.6601,	Adjusted R-squared:  0.5752 
#F-statistic: 7.769 on 1 and 4 DF,  p-value: 0.04945
...
##NEW
#Multiple R-squared:  0.009442,	Adjusted R-squared:  -0.1144 
#F-statistic: 0.07625 on 1 and 8 DF,  p-value: 0.7894
...
#now plot full plot again with all ab lines separately
tiff("reviewer_responses/All_342_noparallel_PC1_vs_StandardLength.tiff", height=8, width=10, units="in", res=300, compression="lzw")
plot(SL$PC1, SL$SL_plot, col = as.character(SL$colour_plot), 
     pch=SL$symb, 
     lwd = 2,
     ylab = "SL",
...
################# 6.4.5 CSS outlier windows PCA without parallel individuals############################### 
#load libraries

pca <- read_table("reviewer_responses/1659_excl_parallel_filt.eigenvec", col_names = FALSE)
eigenval <- scan("reviewer_responses/1659_excl_parallel_filt.eigenval")
...
#
#tiff("1659_noparallel.tiff", height=8, width=8, units="in", res=300, compression="lzw")
plot(pca$PC1, 
     pca$PC2, 
     col = as.character(pca$colour_plot), 
     pch=pca$symb,
     ...
     xlab = (paste0("PC1 (", signif(pve$pve[1], 3), "%)")), 
     ylab = (paste0("PC2 (", signif(pve$pve[2], 3), "%)")), cex = 1.75,
     main = "all_samples - 1659 CS' outlier windows - no scaff22 GRC peak")
#text(pca$PC1, pca$PC2, pca$ind, cex = 0.5, pos = 3)
legend('topright', 
       legend = c("Brienz", "Thun", "Contance", "Walen", "Zurich", "Luzern", "Biel", "Neuchatel", "albeli", "felchen", 'balchen', "large pelagic", "benthic profundal", "pelagic profundal"), 
       col = c("chartreuse2", "chartreuse4", "goldenrod", "mediumpurple1", "purple4", "#ff4489", "paleturquoise2", "turquoise4", "black", "black", "black", "black", "black", "black"), 
...
plot(newplot2_df$PC1, newplot2_df$plotnumber,
     ...
     ylab= "",
     xlab = (paste0("PC1 (", signif(pve$pve[1], 3), "%)")),
     main = "CSS outlier windows no parallel")
axis(2, at = c(0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55), labels=c("Constance - Rare", "Constance - Common", "Lucerne - Rare", "Lucerne - Common", "Thun - Rare", "Thun - Common", "Brienz", "Zurich", "Walen", "Biel", "Neuenburg"), las=1, cex = 1)
abline(h=0.025, col = "black", lty = 3)
abline(h=0.125, col = "black", lty = 3)
abline(h=0.225, col = "black", lty = 3)
...
PC1_GRC <- lm(gill$gill_plot ~ gill$PC1)
summary(PC1_GRC)
#Multiple R-squared:  0.1135,	Adjusted R-squared:  0.09968 
#F-statistic: 8.197 on 1 and 64 DF,  p-value: 0.005667
...
PC1_GRC_NOPROF <- lm(gill_noprof$gill_plot ~ gill_noprof$PC1)
summary(PC1_GRC_NOPROF)
#Multiple R-squared:  0.2201,	Adjusted R-squared:  0.2073 
#F-statistic: 17.22 on 1 and 61 DF,  p-value: 0.000105
...
PC1_GRC_L <- lm(luzern_gill$gill_plot ~ luzern_gill$PC1)
summary(PC1_GRC_L)
#Multiple R-squared:  0.7258,	Adjusted R-squared:  0.6984 
#F-statistic: 26.47 on 1 and 10 DF,  p-value: 0.0004346
...
PC1_GRC_W <- lm(walen_gill$gill_plot ~ walen_gill$PC1)
summary(PC1_GRC_W)
#Multiple R-squared:  0.6087,	Adjusted R-squared:  0.5696 
#F-statistic: 15.55 on 1 and 10 DF,  p-value: 0.002757
...
PC1_GRC_B <- lm(brienz_gill$gill_plot ~ brienz_gill$PC1)
summary(PC1_GRC_B)
#Multiple R-squared:  0.1508,	Adjusted R-squared:  0.1122 
#F-statistic: 3.906 on 1 and 22 DF,  p-value: 0.06079
...
PC1_GRC_N <- lm(neuchatel_gill$gill_plot ~ neuchatel_gill$PC1)
summary(PC1_GRC_N)
#Multiple R-squared:  0.001641,	Adjusted R-squared:  -0.3311 
#F-statistic: 0.00493 on 1 and 3 DF,  p-value: 0.9484
...
PC1_GRC_C <- lm(constance_gill$gill_plot ~ constance_gill$PC1)
summary(PC1_GRC_C)
#Multiple R-squared:  0.2553,	Adjusted R-squared:  0.1622 
#F-statistic: 2.742 on 1 and 8 DF,  p-value: 0.1363
...
PC1_SL <- lm(SL$SL_plot ~ SL$PC1)
summary(PC1_SL)
#Multiple R-squared:  0.2081,	Adjusted R-squared:  0.1957 
#F-statistic: 16.82 on 1 and 64 DF,  p-value: 0.0001183
